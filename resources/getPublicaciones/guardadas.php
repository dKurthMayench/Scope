<?php
    ...
    //recupero las publicaciones que ha guardado el usuario
    $res = $con->query("SELECT * FROM articulos WHERE id IN (SELECT art FROM publicacionesGuardadas WHERE alias='".$_SESSION['user']['alias']."');");
